...
#define CONTROLLER_KEYBOARD_A_LEFT 'F'
#define CONTROLLER_KEYBOARD_A_RIGHT 'H'
#define CONTROLLER_KEYBOARD_A_UP 'T'
#define CONTROLLER_KEYBOARD_A_DOWN 'G'
...
#define CONTROLLER_KEYBOARD_B_DOWN  'X'//VK_NUMPAD8
#define CONTROLLER_KEYBOARD_B_SELECT 'Y'//VK_MULTIPLY
